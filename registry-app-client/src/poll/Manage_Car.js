...
class ManageCar extends Component {
    ...
    barchart = () => {
        $.ajax({
            url: "http://localhost:8080/everyone/thongtindangkiemreport",
            type: 'GET',
        ...
        setTimeout(
            () => window.open('http://localhost:5500/polling-app-client/src/report/expired.pdf'),
            5000
        );
        ...
        return (
            <div className='list_xe' id="list_xe">
                ...
                <div>
                    ...
                    <button className='btn-manage' onClick={this.handleFilterClick}>Lọc</button>
                    <button className='btn-manage' id='chart' onClick={this.barchart}>Thống kê</button>
                </div>
